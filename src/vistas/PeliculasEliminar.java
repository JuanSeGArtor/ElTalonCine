...
public class PeliculasEliminar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        peliculaId = new javax.swing.JLabel();
        ...
        peliculaId.setFont(new java.awt.Font("Segoe UI", 2, 12)); // NOI18N
        peliculaId.setText("ID de la Película:");

        jLabel12.setFont(new java.awt.Font("Segoe UI", 3, 18)); // NOI18N
        jLabel12.setText("Película");

        jLabel23.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jLabel23.setText("ELIMINAR PELÍCULA");
    ...
    private void btnAceptar(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptar
        try {
            int peliculaId = Integer.parseInt(spnId.getValue().toString());
            PeliculasControlador control = PeliculasControlador.getInstance();
            control.eliminar(peliculaId);
    ...
    private javax.swing.JLabel peliculaId;
